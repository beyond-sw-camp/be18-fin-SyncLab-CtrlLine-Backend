...
public class ProductionPlanListResponseDto {
    private Long id;
    ...
    public static ProductionPlanListResponseDto fromEntity(ProductionPlans productionPlans) {
        return ProductionPlanListResponseDto.builder()
